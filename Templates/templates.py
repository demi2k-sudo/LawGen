...
def make_vectorstore(text_chunks):
    ...
    vectorstore.save_local('F:\Legal Assistant\main\Templates\Vectorstore')
...
def Develop():
    if len(os.listdir('F:\Legal Assistant\main\Templates\Vectorstore'))<1:
        load_dotenv()
                
        raw_text = get_pdf_text(os.listdir('F:\Legal Assistant\main\Templates\data'))
